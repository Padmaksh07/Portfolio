...
// ════════════════════════════════════════════════════════
// NEON OUTLINE SYNC FOR SHOWREEL
// ════════════════════════════════════════════════════════
(function initNeonSync() {
  const root = document.documentElement;
  const period = 7000; // ms — keep in sync with other background rhythms (laptop glow uses 7s)

  function step(now) {
    const phase = Math.sin((now / period) * Math.PI * 2) * 0.5 + 0.5; // 0..1
    root.style.setProperty('--neon-intensity', phase.toFixed(3));
